...
angular.module('app')
	...
	.constant('JQ_CONFIG', {
		...
		datetimepicker:['vendor/jquery/datetimepicker/datetimepicker.js',
		              'vendor/jquery/datetimepicker/datetimepicker.css',
		              'vendor/jquery/datetimepicker/datetimepicker.min.css',
		              'vendor/jquery/datetimepicker/datetimepicker.min.js',
		              'vendor/jquery/datetimepicker/datetimedefine.js'
		],
	/*	calendar:['vendor/jquery/fullcalendar/calendar.js']*/
		/*,{
				name: 'calendar',
				files: [
					'./vendor/jquery/fullcalendar/calendar.js',
		            './vendor/jquery/fullcalendar/calendar.css',
		            './vendor/jquery/fullcalendar/jquery.easyui.min.js'
				]
			},{
				name: 'bar',
				files: [
					'vendor/jquery/charts/bar/echarts.min.js'
				]
			}*/
	...
	.config(['$ocLazyLoadProvider', function($ocLazyLoadProvider) {
		...
		$ocLazyLoadProvider.config({
			...
			modules: [{
				...
				name: 'treeControl',
				files: [
					'vendor/modules/treeControl/angular-tree-control.js',
					'vendor/modules/treeControl/tree-control.css'
				]
			},{
				name: 'meta.umeditor',
				files: [
				    './vendor/jquery/umeditor/themes/default/css/umeditor.css',
					'./vendor/jquery/umeditor/umeditor.js',
					'./vendor/jquery/umeditor/umeditor.config.js',
					'./vendor/jquery/umeditor/meta.umeditor.js'
				]
			}, {
				name: 'toastr',
				files: [
					'vendor/modules/angular-toastr/angular-toastr.js',
					'vendor/modules/angular-toastr/angular-toastr.tpls.js',
					'vendor/modules/angular-toastr/angular-toastr.css'
				]
			}
			, {
				name: 'multi-select-tree',
				files: [
					/*'vendor/modules/angular-multi-select-tree/angular-multi-select-tree-0.1.0.js',
					'vendor/modules/angular-multi-select-tree/angular-multi-select-tree-0.1.0.tpl.js',
					'vendor/modules/angular-multi-select-tree/angular-multi-select-tree-0.1.0.css'*/
				]
			}
			]
		});
