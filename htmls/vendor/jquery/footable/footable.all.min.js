		...
		t.name = "Footable Sortable", t.init = function(a) {
			t.footable = a, a.options.sort === !0 && e(a.table).unbind(".sorting").bind({
				"footable_initialized.sorting": function() {
					...
					if(n.data("sort") !== !1) {
						n.find("> thead > tr:first-child > th, > thead > tr:first-child > td").each(function() {
						...
						}), n.find("> thead > tr:first-child > th." + r.sortable + ", > thead > tr:first-child > td." + r.sortable).unbind("click.footable").bind("click.footable", function(a) {
				...
				"footable_redrawn.sorting": function() {
					...
					i.data("sorted") >= 0 && i.find("> thead > tr:first-child > th").each(function(a) {
						var i = e(this);
			...
			if(e(o.table).data("sort") !== !1) {
				var n = e(o.table),
					r = n.find("> tbody"),
					l = o.columns[a],
					s = n.find("> thead > tr:first-child > th:eq(" + a + ")"),
				...
				u && u.result === !1 || (n.data("sorted", l.index), n.find("> thead > tr:first-child > th, > thead > tr:last-child > td").not(s).removeClass(d.sorted + " " + d.descending), i === undefined && (i = s.hasClass(d.sorted)), i ? s.removeClass(d.descending).addClass(d.sorted) : s.removeClass(d.sorted).addClass(d.descending), t.sort(o, r, l, i), o.bindToggleSelectors(), o.raise(f.sorted, {
					column: l,
					direction: i ? "ASC" : "DESC"
				}))
			}
			...
			t.options.bookmarkable.enabled && e(t.table).bind({
				footable_initialized: function() {
					...
					if(o) {
						...
						e(d).val(o), e(t.table).trigger("footable_filter", {
							filter: o
						})
					}
