(function($) {
	...
	function init(target) {
		$(target).addClass('calendar').wrapInner(
			...
			'&nbsp;' +
			'<a class="calendar-prevmonth" href="javascript:;">上一月</a>' +
			'&nbsp;' +
			'<span class="calendar-month"></span>' +
			'&nbsp;' +
			'<a class="calendar-nextmonth" href="javascript:;">下一月</a>' +
				...
				if(opts.month == day[1]) {
					...
					if(opts.lunarDay) {
						...
						if(opts.solarTerms && info.solarTerms) {
							...
							/*	dayHtml += '<span style="color:#E0366E">' + info.solarTerms + '</span>';*/
							Festival = '<span style="color:#E0366E">' + info.solarTerms + '</span>';
						} else {
					...
					if(info.lunarFestival) {
						...
						Festival = '<span style="color:#E0366E">' + info.lunarFestival + '</span>';

					}
					if(info.solarFestival) {
						Festival = '<span style="color:#E0366E">' + info.solarFestival + '</span>';
					}
					dayHtml += Festival;
