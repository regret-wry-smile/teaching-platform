...
var DropDownTreeView = kendo.ui.Widget.extend({
    ...
    init: function (element, options) {
        ...
        $(element).append(kendo.format("<div id='extTreeView{0}' class='k-ext-treeview' style='z-index:1050;'/>", that._uid));
        ...
        that._treeview.bind("select", function (e) {
            ...
            $dropdownRootElem.find("span.k-input").attr("UUID", treeValue.UUID);
        });
