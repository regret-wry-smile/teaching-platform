angular.module('multi-select-tree').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('src/multi-select-tree.tpl.html',
    ...
    "    <span ng-if=\"selectedItems.length > 0\" class=\"selected-items\">\r" +
    "\n" +
    "      <span ng-repeat=\"i in selectedItems\" class=\"selected-item\">{{i.name}} <span ng-if=\"multiSelect\" class=\"selected-item-close\"\r" +
    "\n" +
   ...
   /* "        <span class=\"caret\"></span>\r" +
    ...
    "            <div class=\"line\">\r" +
    "\n" +
    "                <input placeholder=\"搜索\" type=\"text\" ng-model=\"filterKeyword\" ng-click=\"onFilterClicked($event)\"\r" +
    "\n" +
    ...
    "\n" +
    "            <tree-item class=\"top-level\" ng-repeat=\"item in inputModel\" item=\"item[0]\" ng-show=\"!item.isFiltered\"\r" +
    "\n" +
...
$templateCache.put('src/multi-select-tree.tpl2.html',
    "<div class=\"tree-control\">\r" +
    "\n" +
    "\r" +
    "\n" +
  ...
  $templateCache.put('src/tree-item.tpl.html',
    ...
    "\n" +
    "                   on-active-item=\"activeSubItem(item, $event)\" ng-show=\"!child.isFiltered\"></tree-item>\r" +
    "\n" +
    "    </ul>\r" +
    "\n" +
    "</li>\r" +
